...
var c, r, m, i = 0, b = [], l = d.__b, H1 = d.__r, p = d.diffed, d1 = d.__c, y = d.unmount;
function a(_, n) {
...
d.__b = function(_) {
    ...
    p && p(_);
    var n = _.__c;
    n && n.__H && n.__H.__h.length && (b.push(n) !== 1 && m === d.requestAnimationFrame || ((m = d.requestAnimationFrame) || function(t) {
        var u, o = function() {
...
var a1 = function(p6, f, c4, n) {
    var l14;
    f[0] = 0;
    for(var u = 1; u < f.length; u++){
        var g2 = f[u++], o = f[u] ? (f[0] |= g2 ? 1 : 2, c4[f[u++]]) : f[++u];
        g2 === 3 ? n[0] = o : g2 === 4 ? n[1] = Object.assign(n[1] || {}, o) : g2 === 5 ? (n[1] = n[1] || {})[f[++u]] = o : g2 === 6 ? n[1][f[++u]] += o + "" : g2 ? (l14 = p6.apply(o, a1(p6, o, c4, [
            "",
            null
...
function b1(p7) {
    var f = M1.get(this);
    return f || (f = new Map, M1.set(this, f)), (f = a1(this, f.get(p7) || (f.set(p7, f = function(c5) {
...
var p1 = b1.bind(Z);
const Counter = ()=>{
    const [count, setCount] = F1(0);
    const increment = R1(()=>setCount((n)=>n + 1
        )
    , []);
    const decrement = R1(()=>setCount((n)=>n - 1
        )
    , []);
    return p1`<section>
